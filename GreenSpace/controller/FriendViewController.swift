...
extension FriendViewController: UITableViewDataSource,UITableViewDelegate, FriendCellDelegate{
    ...
    //버튼 클릭시 이벤트
    func didPressBtn(for index: Int, press: Bool) {
        if press{
            //팔로우 버튼 클릭시
            if toggleIndex==1{
...
//            //데이터 삭제
//            if(toggleIndex==0){
//                Follows.append(Names[indexPath.row])
//                AllNames.remove(at: indexPath.row)
//                Names.remove(at: indexPath.row)
//                dataArray.remove(at: indexPath.row)
//                FriendTable.deleteRows(at: [indexPath], with: .fade)
//                FriendTable.endUpdates()
//            }
//        }
//    }
////            else{
////                Follows.remove(at: indexPath.row)
////                Names.remove(at: indexPath.row)
////                dataArray.remove(at: indexPath.row)
////                FriendTable.deleteRows(at: [indexPath], with: .fade)
////                FriendTable.endUpdates()
